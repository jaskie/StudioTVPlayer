...
{
    public class WatchersViewModel : ViewModelBase
    {
        ...
        private WatchedFolder _selectedPath;
        public WatchedFolder SelectedPath
        {
            get => _selectedPath;
            set => Set(ref _selectedPath, value);
        }

        public ObservableCollection<WatchedFolder> WatcherMetas { get; } = new ObservableCollection<WatchedFolder>();

        public WatchersViewModel(IExchangeService vMNotifyService)
        {
        ...
        {
            foreach (var watchedFolder in _globalApplicationData.Configuration.WatchedFolders)
            {
                WatcherMetas.Add(watchedFolder);
            }
        }
        ...
        private void DeleteRow(object obj)
        {
            if (obj != null)
            {
                WatcherMetas.Remove((WatchedFolder)obj);
            }
        }       

        private void AddRow(object obj)
        {
            WatcherMetas.Add(new WatchedFolder());            
        }
