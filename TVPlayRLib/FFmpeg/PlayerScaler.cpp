...
bool PlayerScaler::Push(const std::shared_ptr<const AVFrame> frame, AVRational input_frame_rate, AVRational input_time_base)
{
	if (!IsInitialized())
...
std::string PlayerScaler::GetFilterString(const std::shared_ptr<const AVFrame>& frame, Common::Rational<int> input_frame_rate)
{
