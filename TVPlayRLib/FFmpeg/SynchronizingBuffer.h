...
{
public:
	SynchronizingBuffer(AVRational video_frame_rate, AVRational video_time_base, const Core::AudioParameters &audio_parameters, std::int64_t capacity, std::int64_t start_timecode, std::int64_t media_duration);
